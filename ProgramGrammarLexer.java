...
public class ProgramGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NOT", "COMMA", "SEMI", "LPAREN", "RPAREN", "LCURLY", "RCURLY", "DOT", 
			"IF", "ELSE", "GREATER", "LESS", "GREATEREQ", "LESSEQ", "EQQ", "NOTEQ", 
			"AND", "OR", "PLUS", "MINUS", "TIMES", "DIV", "MOD", "POW", "EQ", "TRUE", 
			"FALSE", "QUOTES", "WRITEKEY", "WHILEKEY", "INT", "FLOAT", "ID", "STRING", 
			"WS"
		};
	}
	...
	public ProgramGrammarLexer(CharStream input) {
		super(input);
